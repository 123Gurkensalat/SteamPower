...
namespace SteamAge.Power.Blocks;
...
internal class BlockSteampot : BlockLiquidContainerBase
{
    ...
    {
        if (liquidContentStack != null && liquidContentStack.ItemAttributes?["inBarrelShape"].Exists == true)
        {
    ...
    public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
    {
        ...
        capi.ShowChatMessage("Steam Age: OnblockInteractStart");
        ...
        BlockEntitySteampot blockEntityBarrel = null;
        if (blockSel.Position != null)
        {
            blockEntityBarrel = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntitySteampot;
        }
    ...
    public override string GetPlacedBlockInfo(IWorldAccessor world, BlockPos pos, IPlayer forPlayer)
    {
        ...
        if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityBarrel blockEntityBarrel)
        {
